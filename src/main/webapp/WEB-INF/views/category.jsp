                ...
                <div class="uk-panel uk-panel-box uk-panel-box-primary">
                    ...
                    <form id="formPrice" class="uk-form uk-form-stacked"> <!--TODO: Need to add action-->
                        <div class="uk-form-row">
                            <label for="minprice" class="uk-form-label" id="priceLabel">Budget</label>
                        ...
                        <div class="uk-form-row">
                            <label for="maxprice" class="uk-form-label">Max. price</label>

                        </div>
                        <div class="uk-form-row">
                            <label id="brandlabel" for="brand" class="uk-form-label">Brand</label>
                            <div class="uk-form-controls">
